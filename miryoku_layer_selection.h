...
U_NP,           U_NP,               U_LT(U_MEDIA, ESC), U_LT(U_NAV, SPACE), U_LT(U_SYM_LEFT, TAB),  U_LT(U_SYM_RIGHT, RET), U_LT(U_NUM, BSPC),  U_LT(U_FUN, DEL),   U_NP,               U_NP
...
U_NU,           U_NU,               U_NU,               U_NU,               U_NA,                   &kp QMARK,              &kp FSLH,           &kp BSLH,           &kp PIPE,           U_NU,           \
&kp LGUI,       &kp LALT,           &kp LCTRL,          &kp LSHFT,          U_NA,                   &kp DLLR,               &kp COMMA,          &kp DOT,            &kp EQUAL,          &kp GRAVE,      \
U_NA,           U_NU,               U_NU,               U_NU,               U_NA,                   &kp HASH,               &kp PLUS,           &kp LT,             &kp GT,             U_NU,           \
U_NP,           U_NP,               U_NA,               U_NA,               U_NA,                   &kp DQT,                &kp SQT,            &kp SEMI,           U_NP,               U_NP

#define MIRYOKU_LAYERMAPPING_MEDIA MIRYOKU_MAPPING
#define MIRYOKU_LAYER_MEDIA \
U_NU,           U_NU,               U_NU,               U_NU,               U_NA,                   U_NU,                   U_NU,               U_NU,               U_NU,               U_NU,           \
&kp LGUI,       &kp LALT,           &kp LCTRL,          &kp LSHFT,          U_NA,                   &kp C_PREV,             &kp C_VOL_DN,       &kp C_VOL_UP,       &kp C_NEXT,         U_NU,           \
U_NA,           U_NU,               U_NU,               U_NU,               U_NA,                   &u_bt_sel_0,            &u_bt_sel_1,        &u_bt_sel_2,        &u_bt_sel_3,        &u_bt_sel_4,    \
U_NP,           U_NP,               U_NA,               U_NA,               U_NA,                   &kp C_NEXT,             &kp C_PP,           &kp C_MUTE,         U_NP,               U_NP
...
U_NP,           U_NP,               &kp DLLR,           &kp N0,             &kp DOT,                U_NA,                   U_NA,               U_NA,               U_NP,               U_NP

#define MIRYOKU_LAYERMAPPING_SYM_RIGHT MIRYOKU_MAPPING
#define MIRYOKU_LAYER_SYM_RIGHT \
U_NU,           &kp PRCNT,          &kp LBKT,           &kp RBKT,           &kp EXCL,               U_NA,                   U_NU,               U_NU,               U_NU,               U_NU,           \
&kp CARET,      &kp AMPS,           &kp LPAR,           &kp RPAR,           &kp AT,                 U_NA,                   &kp LSHFT,          &kp LCTRL,          &kp LALT,           &kp LGUI,       \
U_NU,           &kp TILDE,          &kp LBRC,           &kp RBRC,           &kp ASTRK,              U_NA,                   U_NU,               U_NU,               U_NU,               U_NA,           \
U_NP,           U_NP,               &kp COLON,          &kp MINUS,          &kp UNDER,              U_NA,                   U_NA,               U_NA,               U_NP,               U_NP
